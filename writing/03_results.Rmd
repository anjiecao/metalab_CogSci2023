...
Stimuli exposure method is a significant predictor of effect sizes in three domains. In Vowel discrimination (native), conditioning studies yielded larger effect sizes than familiarization studies ($\beta$ = `r filter(ep_models, dataset =="Vowel discrimination (native)", group == " Conditioning")$estimate_print`, *z* = `r filter(ep_models, dataset =="Vowel discrimination (native)", group == " Conditioning")$z_print`, *p* `r filter(ep_models, dataset =="Vowel discrimination (native)", group == " Conditioning")$p_print`). 
