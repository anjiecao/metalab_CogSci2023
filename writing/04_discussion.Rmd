...
```{r 2-col-imageb, fig.env = "figure*", fig.pos = "h", fig.width=5, fig.height=5, fig.align = "center", set.cap.width=T, num.cols.cap=2, fig.cap = "This image spans both columns. And the caption text is limited to 0.8 of the width of the document."}
