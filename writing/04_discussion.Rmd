...
Of course, meta-analysis is not a perfect tool either. Despite the inclusion of a variety of moderators, we can explain relatively variation in the datasets. One measure of heterogeneity is $I^2$, which calculates the proportion of variance accounted for by the meta-analytic model, relative to the total variance in the dataset. The mean $I^2$ across all the models we ran was `r m_i2` (*SD* : `r sd_i2`), indicating that the majority of the variation in effects across studies was unexplained by our moderators [@higgins2002quantifying]. 
